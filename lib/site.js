...
export const products = [
  ...
  { slug: 'bus-shelter',     name: 'Concast bus shelter',       note: 'Public bus shelters, delivered and set.',                                   legacy: '/precast-concast-bus-shelter-in-coimbatore.php',              image: 'velan-mist/images-mist/images/webimages/products/precast%20electrical-chambers-in-coimbatore.webp' },
  { slug: 'toilets',         name: 'Concast toilets & urinals', note: 'Public toilet and urinal units.',                                           legacy: '/precast-concast-toilets-and-urinal-units-in-coimbatore.php', image: 'velan-mist/images-mist/images/webimages/products/precast-concast-house-in-karumathampatti.webp' },
  ...
  { slug: 'box-culverts',    name: 'Box culverts',              note: 'Precast box culverts for road and drainage crossings.',                     legacy: '/precast-box-culverts-in-coimbatore.php',                     image: 'velan-mist/images-mist/images/webimages/products/precast-concrete-products-in-karumathampatti.webp' },
  { slug: 'staircase',       name: 'Staircase',                 note: 'Precast staircase flights.',                                                legacy: '/precast-concrete-staircase-in-coimbatore.php',               image: 'velan-mist/images-mist/images/webimages/products/precast-concrete-footings-in-coimbatore.webp' },
  { slug: 'barriers',        name: 'Traffic control barriers',  note: 'Barriers and other precast site products.',                                 legacy: '/precast-traffic-control-barriers-in-coimbatore.php',         image: 'velan-mist/images-mist/images/webimages/products/other-product3.webp' },
]
